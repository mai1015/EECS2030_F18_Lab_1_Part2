...
public class TestMatrix {
	...
	public void custom01_ShiftUp() {
        ...
        m1.setRow(0, nr0);
        m1.shiftUp();
        assertArrayEquals(nr0, m1.imp[0]);
    }

    @Test
    public void custom02_ShiftLeft() {
	    ...
	    m1.setColumn(0, nc);
	    m1.shiftLeft();
	    assertArrayEquals(nc, m1.getColumn(0));
    }

    @Test
    public void custom03_RotateClockwise() {
        Matrix m1 = new Matrix(1, 1,1);

        int[] nc = {1};

        m1.rotateClockwise();
        assertEquals(nc[0], m1.get(0,0));
    }

    @Test
    public void custom04_() {
        Matrix m1 = new Matrix(1, 1,1);
